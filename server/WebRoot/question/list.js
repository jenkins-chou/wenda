	...
	layui
			...
			.use(
					...
					function() {
						...
						table.render({
							elem : '#list',
							url : ctxPath + '/question/list' // 数据接口
							,
							cols : [ [ // 表头
							{
								type : 'checkbox',
						...
						var $ = layui.$, active = {
							add : function() { // 获取选中数据
								index = layer.open({
									...
									type : 2,
									area : [ '800px', '700px' ],
									content : ctxPath + "/question/toadd"
								});
...
//	
//	
// $.get(ctxPath+"/question/list", function(data){
// newsData=data;
// //执行加载数据的方法
// newsList();
// })
...
// var dataHtml = '';
// if(!that){
// currData = newsData.concat().questionlice(curr*nums-nums, nums);
// }else{
// currData = that.concat().questionlice(curr*nums-nums, nums);
// }
...
// }
// }else{
// dataHtml = '<tr><td colquestionan="8">暂无数据</td></tr>';
// }
// return dataHtml;
// }
//
