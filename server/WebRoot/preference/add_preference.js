layui
		...
		.use(
				...
				function() {
					...
					// 监听提交
					form.on('submit(add_preference)', function(data) {
						parent.resetSwClose(true);
						layer.msg('正在保存。。。', {time : 1000},function(){});
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/preference/updatePreference";
						else
							url=ctxPath+"/preference/addPreference";
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/preference/getPreferenceById","id="+id,function(jsondata){
