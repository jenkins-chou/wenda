layui
		...
		.use(
				...
				function() {
					...
					// 监听提交
					form.on('submit(add_know_history)', function(data) {
						parent.resetSwClose(true);
						layer.msg('正在保存。。。', {time : 1000},function(){});
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/know_history/updateKownledgeHistory";
						else
							url=ctxPath+"/know_history/addKownledgeHistory";
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/know_history/getKownledgeHistoryById","id="+id,function(jsondata){
