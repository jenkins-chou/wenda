layui
		...
		.use(
				...
				function() {
					...
					// 监听提交
					form.on('submit(add_know)', function(data) {
						parent.resetSwClose(true);
						layer.msg('正在保存。。。', {time : 1000},function(){});
						var url="";
						if(id!=null&&id!='')
							url=ctxPath+"/know/updateKownledge";
						else
							url=ctxPath+"/know/addKownledge";
					...
					//获取信息
					if(id!=null&&id!=''){
						$.getJSON(ctxPath+"/know/getKownledgeById","id="+id,function(jsondata){
